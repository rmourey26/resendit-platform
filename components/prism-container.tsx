...
function LoadingFallback() {
  return (
    <div className="w-full h-[70vh] md:h-[80vh] flex items-center justify-center bg-gradient-to-b from-gray-900 to-black">
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-300">Loading 3D visualization...</p>
      </div>
    </div>
  )
}
