    ...
    if (publicId) {
      const url =
        typeof window !== "undefined"
          ...
          : `${process.env.NEXT_PUBLIC_APP_URL || "https://platform.resend-it.com"}/p/${publicId}`
      setShareUrl(url)
    }
  }, [publicId])
        ...
        if (result.success && result.public_id) {
          ...
          const url =
            typeof window !== "undefined"
              ...
              : `${process.env.NEXT_PUBLIC_APP_URL || "https://platform.resend-it.com"}/p/${result.public_id}`
